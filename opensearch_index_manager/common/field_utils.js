...
function getValueType(value) {
  if (value === null) return types_1.FieldType.NULL;
  if (Array.isArray(value)) return types_1.FieldType.ARRAY;
  const typeofValue = typeof value;
  switch (typeofValue) {
    case "string":
      return types_1.FieldType.STRING;
    case "number":
      return types_1.FieldType.NUMBER;
    case "boolean":
      return types_1.FieldType.BOOLEAN;
    case "object":
      return types_1.FieldType.OBJECT;
    default:
      return types_1.FieldType.STRING;
  }
}
