  ...
  router.post(
    {
      ...
      validate: {
        ...
        body: config_schema_1.schema.object({
          query: querySchema,
          from: config_schema_1.schema.maybe(
            config_schema_1.schema.number({ min: 0 })
          ),
          size: config_schema_1.schema.maybe(
            config_schema_1.schema.number({ min: 1, max: 1000 })
          ),
          sort: config_schema_1.schema.maybe(
            config_schema_1.schema.arrayOf(
              config_schema_1.schema.recordOf(
                config_schema_1.schema.string(),
                config_schema_1.schema.any()
              )
            )
          ),
          _source: config_schema_1.schema.maybe(
            config_schema_1.schema.oneOf([
              config_schema_1.schema.boolean(),
              config_schema_1.schema.arrayOf(config_schema_1.schema.string()),
            ])
          ),
  ...
  router.post(
    {
      ...
      validate: {
        ...
        body: config_schema_1.schema.object({
          ...
          fields: config_schema_1.schema.maybe(
            config_schema_1.schema.arrayOf(config_schema_1.schema.string())
          ),
          from: config_schema_1.schema.maybe(
            config_schema_1.schema.number({ min: 0 })
